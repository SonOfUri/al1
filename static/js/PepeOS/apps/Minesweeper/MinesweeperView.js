...
import dead from "@assets/pepeOS-icons/rage.webp";
import smile from "@assets/pepeOS-icons/happy.webp";
import win from "@assets/pepeOS-icons/happy.webp";
import ohh from "@assets/pepeOS-icons/wow.webp";
...
function MineSweeperView({
  ...
  function statusFace() {
    if (mouseDownContent)
      return (
        <img alt="ohh" src={ohh} style={{ maxWidth: 25, maxHeight: 25 }} />
      );
    switch (status) {
      case "died":
        return (
          <img alt="dead" src={dead} style={{ maxWidth: 25, maxHeight: 25 }} />
        );
      case "won":
        return (
          <img alt="win" src={win} style={{ maxWidth: 25, maxHeight: 25 }} />
        );
      default:
        return (
          <img
