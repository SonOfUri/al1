...
import { c as buildTransactionFunction, T as Transaction, f as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-f00ebfad.browser.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-2b422251.browser.esm.js';
import EventEmitter from 'eventemitter3';
import invariant from 'tiny-invariant';
import { n as normalizePriceValue } from './normalizePriceValue-cb39b65f.browser.esm.js';
import { defaultChains } from '@thirdweb-dev/chains';
import { GENERATED_ABI } from '@thirdweb-dev/generated-abis';
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployWithThrowawayDeployer-4f9d31c5.browser.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-0e663366.browser.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
