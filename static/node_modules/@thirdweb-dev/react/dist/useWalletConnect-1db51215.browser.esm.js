...
import { B as Button, s as spacing, u as useTWLocale, a as iconSize, n as TextDivider, C as Container, M as ModalHeader, S as Spacer, o as ModalTitle, T as Text, c as Spinner, p as fadeInAnimation, I as Input, f as fontSize, q as media, t as IconButton, L as Line, v as InputContainer, w as InputButton, W as WalletEntryButton, b as ModalDescription, e as Label, x as ScreenBottomContainer, r as radius, y as shadow, z as noScrollBar, A as lightThemeObj, D as darkThemeObj, E as Img, i as isMobile, F as Link, d as ModalConfigCtx, G as TOS, m as useSetIsWalletModalOpen, H as SetModalConfigCtx, k as useIsWalletModalOpen, J as WalletSelector, K as WalletUIStatesProvider, N as ThirdwebLocaleContext, j as en } from './formElements-682433d8.browser.esm.js';
import { I as InputSelectionUI, e as emailIcon, u as useScreenContext, r as reservedScreens, T as ToolTip, m as modalCloseFadeOutDuration, w as wideModalMaxHeight, a as modalMaxWidthCompact, b as modalMaxWidthWide, c as compactModalMaxHeight, s as smartWalletIcon, o as onModalUnmount, d as useScreen, S as ScreenContext, f as defaultTheme } from './Tooltip-350331d6.browser.esm.js';
import { useCreateWalletInstance, useSetConnectionStatus, useSetConnectedWallet, useConnectionStatus, useWalletContext, useWallet, useAddress, useStorage, useSupportedChains, useSwitchChain, useChainId, useBalance, useChain, useDisconnect, useWalletConfig, useENS, useSDK, useLogin, useWallets, useThirdwebAuthContext, useLogout, useNetworkMismatch, useUser, resolveMimeType, useSDKChainId, useContract, ThirdwebProviderCore, useConnect } from '@thirdweb-dev/react-core';
...
import { F as FormFieldWithIconButton, Q as QRCode, s as safeChainIdToSlug, w as wait, b as WalletLogoSpinner, H as HeadlessConnectUI, d as defaultWallets } from './safeChainSlug-be53623c.browser.esm.js';
...
const EmbeddedWalletFormUI = props => {
  ...
  return /*#__PURE__*/jsxs("div", {
    children: [enableGoogleLogin && /*#__PURE__*/jsx(Fragment, {
    ...
    }), enableGoogleLogin && enableEmailLogin && /*#__PURE__*/jsx(TextDivider, {
...
const DEFAULT_AUTH_OPTIONS = ["email", "google"];
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./safeChainSlug-be53623c.browser.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./safeChainSlug-be53623c.browser.esm.js').then(function (n) { return n.T; });
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./safeChainSlug-be53623c.browser.esm.js').then(function (n) { return n.h; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./safeChainSlug-be53623c.browser.esm.js').then(function (n) { return n.g; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-eed6db1d.browser.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-1131e822.browser.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-fe62eb59.browser.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./safeChainSlug-be53623c.browser.esm.js').then(function (n) { return n.i; });
    return connect(walletConnect(options), options);
  }, [connect]);
}

export { ConnectWallet as C, ExportLocalWallet as E, GoogleIcon as G, MediaRenderer as M, NetworkSelector as N, OTPInput as O, ThirdwebProvider as T, Web3Button as W, ConnectModalInline as a, useRainbowWallet as b, useTrustWallet as c, defaultTokens as d, embeddedWallet as e, useMetamask as f, useCoinbaseWallet as g, useFrameWallet as h, useBloctoWallet as i, useEmbeddedWallet as j, useEmbeddedWalletSendVerificationEmail as k, usePaperWalletUserEmail as l, usePaperWallet as m, useWalletConnect as n, useWalletConnectV1 as o, useResolvedMediaType as p, ThirdwebNftMedia as q, openGoogleSignInWindow as r, shortenAddress as s, useInstalledWallets as u };
